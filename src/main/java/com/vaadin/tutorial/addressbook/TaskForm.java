...
public class TaskForm extends FormLayout {
    ...
    private void buildLayout() {
        ...
        addComponents(actions, firstName, lastName, taskName, startDate, endDate);
    }
    ...
    public void save(Button.ClickEvent event) {
        try {
            ...
            String msg = String.format("Saved '%s %s %s'.", task.getFirstName(),
                    task.getLastName(), task.getTaskName());
