...
public class AddressbookUI extends UI {
    ...
    /* ContactService mimics a real world DAO, that you'd typically implement
     * as EJB or Spring Data based service.
     */
     ...
     *
     * @param request the request object contains some low level web request
     * data that you can typically ignore.
     */
    @Override
    ...
    /* These methods are public and are called by ContactForm when user
     * wants to persist or reset changes to the edited contact.
     */
