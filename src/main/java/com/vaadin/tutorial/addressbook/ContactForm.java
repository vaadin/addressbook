...
public class ContactForm extends FormLayout {
    ...
    DateField phone = new DateField("Start Date");
    TextField email = new TextField("Task");
    DateField birthDate = new DateField("Expected End Date");
    ...
    private void buildLayout() {
        ...
        addComponents(actions, firstName, lastName, email, phone, birthDate);
    }
